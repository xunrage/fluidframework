...
namespace FluidFramework.SqlServer.Data
{
    ...
    public class SqlServerFluidAdapter
    {
        ...
        /// </summary>
        public SqlServerFluidAdapter Fragment(string fragmentValue)
        {
        ...
        /// </summary>
        public SqlServerFluidAdapter ComplexFragment(string fragmentName, string fragmentValue)
        {
            if (String.IsNullOrEmpty(Adapter.SelectCommand.CommandText)) return this;
        ...
        /// </summary>
        public SqlServerFluidAdapter ComplexFragmentCleanUp()
        {
