...
{
    /// <summary>
    /// Inherited by a data service that works with Oracle server.
    /// </summary>
    public partial class OracleDataService : Component
    {
        #region Properties

        /// <summary>
        /// Protected member for connection string used to create the connection to the Oracle server.
        /// </summary>
        ...
        /// </summary>
        protected OracleConnection _globalConnection;

        /// <summary>
        /// Protected member for the global transaction object.
        /// </summary>
        protected OracleTransaction _globalTransaction;
        ...
        /// <summary>
        /// Connection string used to create the connection to the Oracle server.        
        /// </summary>
        ...
        /// </summary>
        public OracleConnection GlobalConnection
        {
        ...
        /// </summary>
        public OracleTransaction GlobalTransaction
        {
        ...
        /// </summary>
        public OracleDataService(IContainer container)
        {
            container.Add(this);
            InitializeComponent();
            Initialize();
        ...
        /// </summary>
        protected void CheckAffectedRows(OracleAdapterConfiguration ac, int affectedRows)
        {
        ...
        /// </summary>
        protected void PerformLoop(List<OracleAdapterConfiguration> listAdapterConfiguration, bool isUpdate)
        {
            ...
            try
            {
                ...
                {
                    sqlTableName = null;
                    OracleAdapterConfiguration ac = listAdapterConfiguration[isUpdate ? index : listAdapterConfiguration.Count - 1 - index];
        ...
        /// </summary>
        public void Perform(List<OracleAdapterConfiguration> listAdapterConfiguration)
        {
        ...
        /// Uses the configuration to perform the required actions over the database.
        /// </summary>
        public void Perform(OracleAdapterConfiguration adapterConfiguration)
        {
            Perform(new List<OracleAdapterConfiguration> { adapterConfiguration });
        }
        ...
        /// </summary>
        protected OracleConnection OpenConnection(OracleConnection sqlConnection = null)
        {
        ...
        /// </summary>
        protected OracleConnection OpenTransactionalConnection(OracleConnection sqlConnection, out OracleTransaction sqlTransaction)
        {
            // Connection
        ...
        /// </summary>
        protected void CloseConnection(OracleConnection sqlConnection)
        {
        ...
        /// </summary>
        protected void CommitTransaction(OracleTransaction sqlTransaction)
        {
        ...
        /// </summary>
        protected void RollbackTransaction(OracleTransaction sqlTransaction)
        {
            if (sqlTransaction != null)
            {
        ...
        /// </summary>
        protected void SetParameters(OracleCommand sqlCommand, List<ParameterInfo> parameterList)
        {
        ...
        /// </summary>
        protected void SetCommand(OracleCommand sqlCommand, OracleConnection sqlConnection, OracleTransaction sqlTransaction = null)
        {
            if (sqlCommand != null)
            {
        ...
        /// </summary>
        protected void UnsetCommand(OracleCommand sqlCommand)
        {
            if (sqlCommand != null)
            {
