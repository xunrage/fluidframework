...
namespace FluidFramework.SQLite.Data
{
    ...
    public partial class SqliteDataService : Component
    {
        ...
        /// </summary>
        public SqliteDataService(SQLiteConnection connection, SQLiteTransaction transaction)
        {
            InitializeComponent();
        ...
        /// </summary>
        protected void GlobalInitialize(SQLiteConnection connection, SQLiteTransaction transaction)
        {
            _connectionString = null;
            _commandTimeout = null;
            _autoRefreshConnection = false;
